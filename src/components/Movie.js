...
import { toggleFavorites, addFavorites, removeFavorite } from '../actions/favoritesActions'
            ...
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <div className="flexContainer">
                        ...
                        <section>
                            {props.favorites ? null : <span className="m-2 btn btn-dark" onClick={handleToggleFavorites}>Favorite</span>}
